...
export class ForkPlugin {
  ...
  utils = {
    ...
    getTokens: async (token: Contract, user: string, amount: BigNumberish): Promise<boolean> => {
    ...
    getTokensFrom: async (token: Contract, from: string, user: string, amount: BigNumberish): Promise<boolean> => {
