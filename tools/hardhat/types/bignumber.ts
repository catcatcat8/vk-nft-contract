...
function formatString(num: string, decimals = 18, precision = decimals, delimiter = '.'): string {
...
BigNumber.prototype.formatString = function (decimals = 18, precision = decimals, delimiter = '.') {
