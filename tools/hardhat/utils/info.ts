...
export const scannersLink = {
  ...
  getBlock: (chainTag: ChainTag, block: string) => getChainScanner(chainTag) + 'block/' + block,
  getAddress: (chainTag: ChainTag, address: string) => getChainScanner(chainTag) + 'address/' + address,
}
